...
public class Task {
	...
	public Task(long id, String taskName, LocalDateTime creationDate, LocalDateTime deleveryDate, 
			String descriptionTask, List<String> files, String createdBy, TaskPriority taskPriority,
			TeamMember teamMember, Status status, Set<Comment> comments) {
		this.id = id;
	...
	public Task(long id, String taskName, LocalDateTime deleveryDate, String descriptionTask,
			List<String> files, TeamMember teamMember, Status status, String createdBy) {
		this();
		this.id = id;
		this.taskName = taskName;
		this.deleveryDate = deleveryDate;
	...
	public String toString() {
		return "Task [id=" + id + ", taskName=" + taskName + ", creationDate=" + creationDate + ", deleveryDate="
				+ deleveryDate + ", descriptionTask=" + descriptionTask + ", files=" + files + ", createdBy="
				+ createdBy + ", taskPriority=" + taskPriority + ", teamMember=" + teamMember + ", status=" + status
				+ ", comments=" + comments + "]";
	}
