...
public class ProjectController {
	...
	public ProjectListDto getProjectDetail(@PathVariable long id) {
		return projectService.getProjectDeatil(id);
...
*/
	...
	public void updateProjectStatus(@RequestBody Project newProject) {
