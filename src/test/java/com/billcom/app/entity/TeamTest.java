...
public class TeamTest {
	...
	//	team = new Team("teamName",teamMember,leader, );
		// then
		Assertions.assertThat(team.getTeamName()).isEqualTo("teamName");
		Assertions.assertThat(team.getTeamMember()).isEqualTo(teamMember);
		Assertions.assertThat(team.getLeader()).isEqualTo(leader);
	}
}
